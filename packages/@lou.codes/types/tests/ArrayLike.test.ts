...
export const ok1: ArrayLike<number, 3> = [1, 2, 3];
...
// @ts-expect-error Length has to match what's set in the ArrayLike
export const wrongLength: ArrayLike<number, 2> = [1, 2, 3];
